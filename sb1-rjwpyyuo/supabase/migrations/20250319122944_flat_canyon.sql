/*
  ...
  1. Changes
    ...
    - Add function to calculate research cost and time
    - Update start_research function to properly handle research upgrades
    - Add checks for requirements and resources
...
BEGIN
  ...
  SELECT 
    ...
    v_base_time * POWER(1.1, p_current_level)::INTERVAL AS upgrade_time;
END;
$$ LANGUAGE plpgsql;
