/*
  # Fix Research Cost Calculation

  1. Changes
    - Fix integer casting in cost calculation
    - Ensure proper rounding of resource costs
    - Maintain proper type handling throughout calculations
